...
class Migration(SchemaMigration):
    def forwards(self, orm):
        db.create_table(u'pybb_topicemailsendusernotification', (
            (u'id',
            ...
            ('topic',
             self.gf('django.db.models.fields.related.ForeignKey')(
                 related_name=u'notifications', to=orm['pybb.Topic'])),
            ('flag',
             self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'pybb', ['TopicEmailSendUserNotification'])

    def backwards(self, orm):
        db.delete_table(u'pybb_topicemailsendusernotification')
    ...
    models = {
        ...
        u'pybb.forum': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [],
                         {'related_name': "u'forums'",
                          'to': u"orm['pybb.Category']"}),
            ...
            u'id': ('django.db.models.fields.AutoField', [],
                    {'primary_key': 'True'}),
            'moderators': ('django.db.models.fields.related.ManyToManyField',
                           [],
                           {'symmetrical': 'False', 'to': u"orm['auth.User']",
                            'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [],
                     {'max_length': '80'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [],
                       {'blank': 'True', 'related_name': "u'child_forums'",
                        'null': 'True',
                        'to': u"orm['pybb.Forum']"}),
            'position': ('django.db.models.fields.IntegerField', [],
                         {'default': '0', 'blank': 'True'}),
            'post_count': ('django.db.models.fields.IntegerField', [],
                           {'default': '0', 'blank': 'True'}),
            'readed_by': ('django.db.models.fields.related.ManyToManyField',
                          [],
                          {'related_name': "u'readed_forums'",
                           'symmetrical': 'False',
                           'through': u"orm['pybb.ForumReadTracker']",
                           'to': u"orm['auth.User']"}),
        ...
        u'pybb.pollanswer': {
            ...
            'topic': ('django.db.models.fields.related.ForeignKey', [],
                      {'related_name': "u'poll_answers'",
                       'to': u"orm['pybb.Topic']"})
        },
        u'pybb.pollansweruser': {
            'Meta': {'unique_together': "((u'poll_answer', u'user'),)",
                     'object_name': 'PollAnswerUser'},
            u'id': ('django.db.models.fields.AutoField', [],
                    {'primary_key': 'True'}),
            'poll_answer': ('django.db.models.fields.related.ForeignKey', [],
                            {'related_name': "u'users'",
                             'to': u"orm['pybb.PollAnswer']"}),
        ...
        u'pybb.post': {
            ...
            'topic': (
                'django.db.models.fields.related.ForeignKey', [],
                {'related_name': "u'posts'", 'to': u"orm['pybb.Topic']"}),
            'updated': ('django.db.models.fields.DateTimeField', [],
                        {'null': 'True', 'blank': 'True'}),
            'user': (
                'django.db.models.fields.related.ForeignKey', [],
                {'related_name': "u'posts'", 'to': u"orm['auth.User']"}),
            'user_ip': ('django.db.models.fields.IPAddressField', [],
                        {'default': "u'0.0.0.0'", 'max_length': '15',
                         'blank': 'True'})
        },
        u'pybb.profile': {
            ...
            'user': ('annoying.fields.AutoOneToOneField', [],
                     {'related_name': "u'pybb_profile'", 'unique': 'True',
                      'to': u"orm['auth.User']"})
        },
        u'pybb.topic': {
            ...
            'readed_by': ('django.db.models.fields.related.ManyToManyField',
                          [],
                          {'related_name': "u'readed_topics'",
                           'symmetrical': 'False',
                           'through': u"orm['pybb.TopicReadTracker']",
                           'to': u"orm['auth.User']"}),
            'sticky': ('django.db.models.fields.BooleanField', [],
                       {'default': 'False'}),
            'subscribers': ('django.db.models.fields.related.ManyToManyField',
                            [],
                            {'symmetrical': 'False',
                             'related_name': "u'subscriptions'",
                             'blank': 'True',
                             'to': u"orm['auth.User']"}),
            'updated': ('django.db.models.fields.DateTimeField', [],
                        {'null': 'True'}),
        ...
        u'pybb.topicemailsendusernotification': {
            'Meta': {'object_name': 'TopicEmailSendUserNotification'},
            'flag': ('django.db.models.fields.BooleanField', [],
                     {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [],
                    {'primary_key': 'True'}),
            'topic': ('django.db.models.fields.related.ForeignKey', [],
                      {'related_name': "u'notifications'",
                       'to': u"orm['pybb.Topic']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [],
                     {'to': u"orm['auth.User']"})
        },
        u'pybb.topicreadtracker': {
            'Meta': {'unique_together': "((u'user', u'topic'),)",
